...
Function InclinationMatcher {
  ...
  ETAToTrueAnomaly(ship, TrueAnomAN).
  set TimeAN to TimeTillDesiredTrueAnomaly.
  ETAToTrueAnomaly(ship, TrueAnomDN).
  ...
  set FinalMan to HillClimbLex["ResultFinder"](InputList, "Inclination", NewScoreList, NewRestrictionList).
