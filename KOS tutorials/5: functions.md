...
On paper this sounds like a great idea but if your instructor tells you ShiftGear() first, second. But you're not sure where to
put 'first' and where to put 'second'. Wouldn't it be handy if you made rule that the first word your instructor says is the
...
So to go from first to second gear you'd use:
...
Now what if you want to use the velocity for other calculations, is that possible? Yes ofcourse that's possible!
