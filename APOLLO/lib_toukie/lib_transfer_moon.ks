...
Function MoonCorrectionBurn {
  ...
  // CHECK POS AND NEG STEPS
  local BestNode  is "".
  local BestNode1 is TX_lib_hillclimb_main["Hillclimber"](NodeList, ParameterList, TX_lib_hillclimb_score["MoonInsertionScore"], "none", -1).
  local BestNode2 is TX_lib_hillclimb_main["Hillclimber"](NodeList, ParameterList, TX_lib_hillclimb_score["MoonInsertionScore"], "none", 1).

  local Score1 is TX_lib_hillclimb_score["MoonInsertionScore"](BestNode1, ParameterList).
  local Score2 is TX_lib_hillclimb_score["MoonInsertionScore"](BestNode2, ParameterList).
...
Function MoonTransfer {
  ...
  local NodeList is list(time:seconds + 30, 0, 0, 0).
  local ParameterList is list(TargetDestination, TargetPeriapsis, TargetInclination, TargetLAN).
  local Restrictions is "time".

  local BestNode  is "".
  local BestNode1 is TX_lib_hillclimb_main["Hillclimber"](NodeList, ParameterList, TX_lib_hillclimb_score["FinalCorrectionScore"], Restrictions, -1, 0.1).
  local BestNode2 is TX_lib_hillclimb_main["Hillclimber"](NodeList, ParameterList, TX_lib_hillclimb_score["FinalCorrectionScore"], Restrictions, 1, 0.1).

  local Score1 is TX_lib_hillclimb_score["FinalCorrectionScore"](BestNode1, ParameterList).
  local Score2 is TX_lib_hillclimb_score["FinalCorrectionScore"](BestNode2, ParameterList).
...
Function ReturnFromMoon {
  ...
  local BestNode  is "".
  local BestNode1 is TX_lib_hillclimb_main["Hillclimber"](ExitList, ParameterList, TX_lib_hillclimb_score["MoonReturnScore"], Restrictions, -1).
  local BestNode2 is TX_lib_hillclimb_main["Hillclimber"](ExitList, ParameterList, TX_lib_hillclimb_score["MoonReturnScore"], Restrictions, 1).

  local Score1 is TX_lib_hillclimb_score["MoonReturnScore"](BestNode1, ParameterList).
  local Score2 is TX_lib_hillclimb_score["MoonReturnScore"](BestNode2, ParameterList).
